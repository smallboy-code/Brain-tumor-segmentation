...
def validate_softmax(
    ...
    runtimes = []
    ET_voxels_pred_list = []
    path = "/mnt/data/data/BraTs2021/RSNA_ASNR_MICCAI_BraTS2021_TrainingData_16July2021/BraTS2021_00000/BraTS2021_00000_seg.nii.gz"
    #path = "/media/dmia/data11/hh/MICCAI_BraTS2020_ValidationData/BraTS20_Validation_001/BraTS20_Validation_001_flair.nii.gz"
    ...
    for i, data in enumerate(valid_loader):
        ...
        if savepath:
            ...
            if save_format == 'nii':
                ...
                _, id = name.split("_")
                oname = os.path.join(savepath, id + '.nii.gz')
