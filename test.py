...
#from models.TransBTS.Conformer_nocnn_Unet import Conformer
#from models.TransBTS.TransBTS_downsample8x_skipconnection import TransBTS
#from models.TransBTS.ConformerBTS import Conformer
...
parser.add_argument('--root', default='data/brats2021', type=str)
...
parser.add_argument('--test_date', default='TransBTS2022-09-19', type=str)
...
def main():
    ...
    load_file = os.path.join(os.path.abspath(os.path.dirname(__file__)),
                             'checkpoint2021', args.experiment+args.test_date, args.test_file)
