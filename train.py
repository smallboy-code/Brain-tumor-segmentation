...
def main_worker():
    ...
    if args.local_rank == 0:
        checkpoint_dir = os.path.join(os.path.abspath(os.path.dirname(__file__)), 'checkpoint2021', args.experiment+args.date)
    ...
    for epoch in range(args.start_epoch, args.end_epoch):
        ...
        for i, data in enumerate(train_loader):
            ...
            #DA1_loss, DA1_loss1, DA1_loss2, DA1_loss3 = criterion(DA1, target)
            #DA2_loss, DA2_loss1, DA2_loss2, DA2_loss3 = criterion(DA2, target)
