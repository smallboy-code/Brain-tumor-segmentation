...
#from models.TransBTS.Conformer_Unet_Encode import Conformer
...
# DataSet Information
parser.add_argument('--root', default='data/brats2020', type=str)
...
def main_worker():
    ...
    #torch.distributed.init_process_group('nccl',init_method="env://", world_size=torch.cuda.device_count(), rank=args.local_rank)
